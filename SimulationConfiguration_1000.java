 ...
 */
 ...
 public class SimulationConfiguration {
   ...
   public static final int NUM_OF_OUTBOUND_CONNECTIONS = 8;//600;//800;//6000;
   
   public static final int NUM_OF_INBOUND_CONNECTIONS = 117;//600;//800;//6000;
   ...
   // TODO
   public static final int AVERAGE_COINS = 500;
   ...
   public static final int END_BLOCK_HEIGHT = 100; //4712;
 
   /** Block size. (unit: byte). */
   public static final long BLOCK_SIZE = 1693450; // 6110;//8000;//535000;//0.5MB
 
   /** The usage rate of compact block relay (CBR) protocol. */
   public static final float CBR_USAGE_RATE = 0.89f;
